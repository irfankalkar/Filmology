<div class="container home_trailer_cards_for_other_movies">
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                <?php $__currentLoopData = $random; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rMovie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="each_trailer_card mb-3" style="max-width: 540px;" title="<?php echo e($rMovie->Movie_Name); ?>">
                        <a href="<?php echo e(route("movie_details", $rMovie->Movie_ID)); ?>">
                            <div class="row g-0">
                                <div class="col-9 col-sm-9 col-md-12 d-sm-block d-lg-none border-bottom border-light movie_title_field_top">
                                    <h6 class="card-title px-1 d-inline fw-bold"> <?php echo e($rMovie->Movie_Name); ?> </h6>
                                </div>
                                <div class="col-3 col-sm-3 d-md-none rating_field_top">
                                    <ul class="list-inline border-bottom border-light bg-dark text-light m-0 px-1 py-1 d-flex flex-row justify-content-center">
                                        ...
                                        <li class="list-inline-item"><span class="fw-bold"><?php echo e($rMovie->IMDB_Point); ?></span></li>
                                    </ul>
                                </div>
                                <div class="col-4 col-sm-3 col-md-4">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <img src="<?php echo e(asset('movie_covers/' .$rMovie->Movie_Cover_URL)); ?>" class="img-fluid"/>
                                        </div>
                                    </div>
...
</div><?php /**PATH C:\Users\user\Desktop\Filmology\resources\views/layouts/sections/home_trailer_cards.blade.php ENDPATH**/ ?>