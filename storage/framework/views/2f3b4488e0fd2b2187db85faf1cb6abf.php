                ...
                <div class="col-md-12 col-xl-10">
                    ...
                    <div class="row rounded-2 border border-white h-100 pt-3">
                        ...
                        <div class="col-md-10 d-flex justify-content-md-start">
                            <h4 class="fw-bold d-none d-md-flex">Sessiz Bir Yer</h4>
                            <h6 class="fw-bold d-flex d-md-none">Sessiz Bir Yer</h6>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="rounded-2 border border-white d-flex justify-content-md-start py-1 px-2 imdb_score">
                                        <ul class="list-inline m-0 d-flex align-items-center">
                                            ...
                                            <li class="list-inline-item mx-0"><span class="fw-bold fs-5">7,5</span></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <div class="rounded-2 border border-white d-flex flex-column flex-md-row justify-content-md-start px-2 py-2">
                                        ...
                                        <h6 class="m-0 d-none d-md-flex">&nbsp;&nbsp;A Quiet Place</h6>
                                        <h6 class="m-0 d-flex d-md-none py-1">A Quiet Place</h6>
                                    </div>
                                </div>
                            ...
                            <div class="row px-0 py-sm-0 py-md-2">
                                ...
                                <div class="col-xl-12 col-lg-9 col-md-8 col-sm-7 order-sm-2 d-flex justify-content-sm-end justify-content-md-end align-items-md-center justify-content-lg-end justify-content-xl-end date_duration_category">
                                    <ul class="list-inline d-sm-flex flex-sm-row justify-content-sm-evenly align-items-sm-center mb-0 p-0">
                                        <li class="list-inline-item border border-white me-1 ms-md-2 mb-1 rounded-2"><span class="p-1">13 Haziran 2018</span></li>
                                        
                                        <li class="list-inline-item border border-white me-1 ms-md-2 mb-1 rounded-2"><span class="p-1">120 Dakika</span></li>
                                        
                                        <li class="list-inline-item border border-white me-1 ms-md-2 mb-1 rounded-2"><span class="p-1">Fantastik</span></li>
                                    </ul>
                                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row rounded-2 border border-white h-100 py-3 py-sm-3 pt-md-3 pb-md-2 pt-lg-3 pt-xl-3 px-xxl-2 pt-xxl-4 cover_and_trailer_field">
                        ...
                        <div class="col-12 col-sm-8 col-md-9 d-flex justify-content-md-start">
                            <iframe class="rounded-2 w-100" src="https://www.youtube.com/embed/i9-jhznkB3g?si=Y4EdWabFLV8475Pk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </div>

                        <div class="col-12">
                            <p class="pt-3 pt-sm-3 pb-md-2 pt-md-3 pt-lg-3 pb-lg-1 py-xl-2 py-xxl-3 mb-0 movie_summary">
                                2 çocuklu bir aile, izole bir kırsalda sakin bir yaşam sürmektedir. Henüz büyüme çağlarında olan çocuklar
                                ...
                                varlığın dikkatini hemen çekecek ve aile sessizliklerini bozmanın bedelini ağır ödeyecektir...
                            </p>
                        </div>
                            ...
                            <div class="row d-flex flex-column">
                                ...
                                <div class="col-md-12">
                                    <ul class="list-inline">
                                        <li class="list-inline-item m-1"><span class="badge rounded-pill text-bg-secondary p-2">Scott Beck</span></li>
                                        <li class="list-inline-item m-1"><span class="badge rounded-pill text-bg-secondary p-2">John Krasinski</span></li>
                                        <li class="list-inline-item m-1"><span class="badge rounded-pill text-bg-secondary p-2">Bryan Woods</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
