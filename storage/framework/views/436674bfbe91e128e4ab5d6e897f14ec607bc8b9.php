        ...
        <div class="each_content_border_color" style="--mt:14px; --mb:14px; --br_size:3px;">
            ...
            <div class="row px-3 pb-3">
                    ...
                    <form action="" method="">
                        ...
                        <div class="row">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control placeholder-icon" placeholder="Tam Ad" aria-label="Username" aria-describedby="basic-addon1">
                                <span class="input-group-text" id="basic-addon1"> <i class="bi bi-person-vcard"></i> </span>
                            </div>
                
                            <div class="input-group mb-3">
                                <input type="number" class="form-control placeholder-icon" placeholder="Telefon Numarası" aria-label="Username" aria-describedby="basic-addon1">
                ...
                <div class="col-md-6">
                    ...
                    <form action="" method="">
                        ...
                        <div class="row">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control placeholder-icon" placeholder="E-mail" aria-label="Username" aria-describedby="basic-addon1">
                                <span class="input-group-text" id="basic-addon1"> <i class="bi bi-at"></i> </span>
                            </div>

                            <div class="input-group mb-5">
                                <input type="password" class="form-control placeholder-icon" placeholder="Şifre (Tekrar)" aria-label="Username" aria-describedby="basic-addon1">
                                <span class="input-group-text" id="basic-addon1"> <i class="bi bi-key-fill"></i> </span>
                            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-4 fw-bolder register_btn_field">
                        <div class="button_su">
    ...
    </div><?php /**PATH C:\wamp64\www\Filmology_irfan\resources\views/layouts/sections/register.blade.php ENDPATH**/ ?>