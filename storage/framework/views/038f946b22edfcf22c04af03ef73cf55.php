        ...
        <nav class="navbar navbar-expand-lg header_options">
            <div class="container-fluid">
                <div class="col-md-2 logo_container">
                    <a class="navbar-brand" href="<?php echo e(route('home_href')); ?>">
                        <img class="" src="<?php echo e(asset('assets/image/logo/Filmology_transparent_no_slogan.png')); ?>" alt="logo_footer">
                    </a>
                </div>
...
<?php /**PATH C:\Users\user\Desktop\Filmology\resources\views/layouts/sections/header.blade.php ENDPATH**/ ?>