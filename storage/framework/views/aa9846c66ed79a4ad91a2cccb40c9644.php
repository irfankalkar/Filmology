...
<?php endif; ?>
        ...
        <div class="each_content mt-3 mb-3" style="--br_size:3px;">
            <div class="row px-3 pb-3">
                ...
                <div class="col-md-12">
                    <form id="contactInfo" action="<?php echo e(route('contact_send')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
    ...
    </div><?php /**PATH C:\wamp64\www\Filmology-main\resources\views/layouts/sections/contact.blade.php ENDPATH**/ ?>