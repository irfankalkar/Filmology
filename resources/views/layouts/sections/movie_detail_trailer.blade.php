        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-3 pt-3">
                    <img class="imgTrailer" src="{{asset('image/movie_detail_img/A_Quiet_Place_film_poster.png')}}"
                        alt="">
                </div>
    ...
    <div class="container swiper each_content movie_bg2 py-3"
        ...
        <div class="slider-wrapper">
            <div class="card-list swiper-wrapper">
                ...
                <!-- <div class="card-item swiper-slide">
              <img src="{{asset('image/movie_detail_img/Arı_Filmi_afişi.jpg')}}" alt="User Image" class="user-image"/>
